...
public sealed class BreakoutRunSetupStateTests
{
    ...
    [Test]
    public void BuildRunSettingsCarriesSelectedPrismLanesGlitch()
    {
        var state = CreateRunSetupState();
        var stateType = state.GetType();
        ...
        Assert.That(runSettings.LevelGlitchesEnabled, Is.True);
        Assert.That(runSettings.SelectedLevelGlitch, Is.EqualTo(LevelGlitchSelection.PrismLanes));
        Assert.That(runSettings.LevelGlitchLabel, Is.EqualTo("Prism Lanes Armed"));
    }

    [Test]
    public void BuildRunSettingsCarriesSelectedPrismShuffleGlitch()
    {
        var state = CreateRunSetupState();
        var stateType = state.GetType();
        ...
        Assert.That(runSettings.LevelGlitchesEnabled, Is.True);
        Assert.That(runSettings.SelectedLevelGlitch, Is.EqualTo(LevelGlitchSelection.PrismShuffle));
        Assert.That(runSettings.LevelGlitchLabel, Is.EqualTo("Prism Shuffle Armed"));
    }
    ...
    [Test]
    public void BuildRunSettingsCarriesSelectedRogueGateGlitch()
    {
        var state = CreateRunSetupState();
        var stateType = state.GetType();
        ...
        Assert.That(runSettings.LevelGlitchesEnabled, Is.True);
        Assert.That(runSettings.SelectedLevelGlitch, Is.EqualTo(LevelGlitchSelection.RogueGate));
        Assert.That(runSettings.LevelGlitchLabel, Is.EqualTo("Rogue Gate Armed"));
    }
